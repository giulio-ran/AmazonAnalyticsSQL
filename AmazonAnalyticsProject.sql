/* In this project I'll use a constructed Kaggle database about amazon sales around north america.
 * The Link for the file download is provided in the GitHub page.  */
